...
public class Home extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (userName == null || userLanguage == null || userHomeTown == null) {
			userName="Unknown";
		...
		out.write("<p>Your favorite language: " +userLanguage+ "<p>");
		out.write("<p>Your hometown: " +userHomeTown+ "<p>");
	}
